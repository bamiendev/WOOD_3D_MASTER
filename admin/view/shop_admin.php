<?php
$html_list_product_3d = show_product_admin($list_product_3d);
$html_list_category_3d = show_category_admin($list_category_3d);
?>
...
<div class="row">
    <div class="col-lg-12 mt-2" id="product_3dD">
        <div
            style="background-color: #f6f6f9;border-radius: 25px; margin-left: 30px;">
            <h2 class="text-center mb-2" style="padding-top: 20px;">Sản Phẩm 3D</h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="background-color: #f6f6f9;border-radius: 25px; margin-left: 30px;">
                    <h2 class="text-center mb-2" style="padding-top: 20px;">Danh Mục 3D</h2>
                    <div class="mb-3" style="display: flex; justify-content: center; align-items: center;">
