...
if (isset($_SESSION['cart_product'])) {
    $count_product = count($_SESSION['cart_product']);

    if ($count_product > 0) {
        $html_showcart = show_cart($_SESSION['cart_product']);
    }
} else {
    $count_product = 0;
}
...
<section>
    <div class="container h-100">
        <div class = "row bill-header">
            ...
            <div class = "col-lg-4">
                <p class = "wishlistNumber float-right">There are <span><?=$count_product?></span> item(s) in your cart</p>
            </div>
        </div>
