...
class PHPMailer
{
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="a.png"> and must not be empty
     * will look for an image file in $basedira.png and convert it to inline.
